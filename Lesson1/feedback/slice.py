...
def even(s):        # 2016.03.17_10:40:47 checked. prusanov
    # +++ ваш код +++
...
# Решите задачу в одну строчку используя срезы.
def reverse(s):     # 2016.03.17_10:40:52 checked. prusanov
    # +++ ваш код +++
...
def shift(s):       # 2016.03.17_10:41:16 checked. prusanov
    # +++ ваш код +++
    return " ".join( s.split(" ")[len(s)-1:-2:-1] + s.split(" ")[:-1:1] )       # s.split() сработает так же, как s.split(" "), но запись короче
...
def palindrome(d):      # 2016.03.17_10:42:12 checked. prusanov
    # +++ ваш код +++
